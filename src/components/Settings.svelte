...
{#if show}
    <nav transition:fly={{x: 250, opacity: 1}}>
        <div class="sliders_div">
            ...
            <label for="altitude">Altitude: {altitude}m</label>
            <input class="slider" id="altitude" type="range" step="100" min="0" max="3000" bind:value={altitude}>
            <label for="temperature">Temperature: {temperature}°C</label>
            <input class="slider" id="temperature" type="range" step="1" min="0" max="40" bind:value={temperature}>
            <label for="humidity">Humidity: {humidity}%</label>
            <input class="slider" id="humidity" type="range" step="1" min="0" max="100" bind:value={humidity}>
        </div>
        <hr class="solid">
        <div class="sliders_div">
            ...
            <label for="wheels_inertia">Wheels Inertia: {wheelsInertia}J/s²</label>
            <input class="slider" id="wheels_inertia" type="range" step="0.001" min="0.01" max="0.15" bind:value={wheelsInertia}>
            ...
            <label for="area">Frontal Area: {area}m²</label>
